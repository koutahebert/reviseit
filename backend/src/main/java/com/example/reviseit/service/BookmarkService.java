...
public class BookmarkService {
    ...
    private String extractDomainName(String url) {
        ...
        try {
            ...
            System.err.println("Error parsing URL for domain extraction: " + url + " - " + e.getMessage());
    ...
    public List<BookmarkDTO> getBookmarksByUserEmail(String email) {
        ...
        User user = userRepository.findByEmail(email)
                .orElseThrow(() -> new RuntimeException("User not found with email: " + email)); // Or a custom exception
    ...
    public BookmarkDTO addBookmark(BookmarkDTO bookmarkDTO, String email) {
        ...
        bookmark.setProgress(bookmarkDTO.getProgress() != null ? bookmarkDTO.getProgress() : 0.0f);
    ...
    public void deleteBookmark(Long bookmarkId, String email) {
        ...
        Bookmark bookmark = bookmarkRepository.findByIdAndUserEmail(bookmarkId, email)
                .orElseThrow(() -> new RuntimeException("Bookmark not found or user does not have permission")); // Or a custom exception
